...
// Copy this to config.local.php and edit for your environment.
...
define('FREE_MAX_IMAGES',      12);
define('FREE_MAX_PRICE_LISTS', 1);
define('FREE_MAX_MENUS',       1);
define('FREE_MAX_ARTICLES',    5);
define('FREE_MAX_CALLOUTS',    6);
define('FREE_MAX_SOCIAL',      3);
define('FREE_MAX_STAFF',       2);
